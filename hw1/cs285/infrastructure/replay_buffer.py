...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        np.random.permutation(self.obs)
        np.random.permutation(self.acs)
        np.random.permutation(self.rews)
        np.random.permutation(self.next_obs)
        np.random.permutation(self.terminals)
        return (
            self.obs[-batch_size:],
            self.acs[-batch_size:],
